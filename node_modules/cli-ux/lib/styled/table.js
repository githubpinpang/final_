...
function table(data, inputOptions = {}) {
    const options = Object.assign({}, inputOptions, { columns: (inputOptions.columns || []).map(c => (Object.assign({ format: (value) => (value != null ? value.toString() : ''), width: 0, label() {
            ...
            } }, c))), colSep: '  ', after: () => { }, headerAnsi: _.identity, printLine: (s) => console.log(s), printRow(cells) {
